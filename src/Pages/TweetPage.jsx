...
export default function TweetPage(props) {
    ...
    useEffect(() => {
        ...
        const fetchTweet = (tweetId) => {
            axios.get(`twitter-clone-backend-in-progress-91yvo9gd7-aditya-prajapati.vercel.app/tweet/gettweet/${tweetId}`,
        ...
        const fetchComments = () => {
            axios.get(`twitter-clone-backend-in-progress-91yvo9gd7-aditya-prajapati.vercel.app/tweet/getcomments/${tweetId}`, // comment is treated as tweet
                { withCredentials: true }
            )
                .then((res) => {
