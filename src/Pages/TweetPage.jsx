...
export default function TweetPage(props) {
    ...
    useEffect(() => {
        ...
        const fetchTweet = (tweetId) => {
            axios.get(`https://twitter-clone-backend-in-progress-9wu76nohl-aditya-prajapati.vercel.app/tweet/gettweet/${tweetId}`,
        ...
        const fetchComments = () => {
            axios.get(`https://twitter-clone-backend-in-progress-9wu76nohl-aditya-prajapati.vercel.app/tweet/getcomments/${tweetId}`, // comment is treated as tweet
                { withCredentials: true }
            )
                .then((res) => {
