...
export default function Login(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            await axios
                .post(
                    "https://twitter-clone-backend-in-progress-9wu76nohl-aditya-prajapati.vercel.app/auth/login",
    ...
    return (
        <div className="card align-items-center" id="Login">
            ...
            <LoginButton link="https://twitter-clone-backend-in-progress-9wu76nohl-aditya-prajapati.vercel.app/auth/google" icon={<GoogleIcon />} text={"Sign in with Google"} />
