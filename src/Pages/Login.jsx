...
export default function Login(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            await axios
                .post(
                    "twitter-clone-backend-in-progress-91yvo9gd7-aditya-prajapati.vercel.app/auth/login",
    ...
    return (
        <div className="card align-items-center" id="Login">
            ...
            <LoginButton link="twitter-clone-backend-in-progress-91yvo9gd7-aditya-prajapati.vercel.app/auth/google" icon={<GoogleIcon />} text={"Sign in with Google"} />
