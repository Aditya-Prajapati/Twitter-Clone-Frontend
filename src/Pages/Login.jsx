...
export default function Login(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            await axios
                .post(
                    "https://twitterclonebackendv1.vercel.app/auth/login",
    ...
    return (
        <div className="d-flex align-items-center justify-content-center" id="LoginContainer">
            <div className="card align-items-center" id="Login">
                ...
                <h3 className="HeadingText">Sign in to <span style={{ color: "#1DA1F2" }}> Twitter Clone </span></h3>
                {/* icon={<GoogleIcon />} */}
                <LoginButton 
                    link="https://twitterclonebackendv1.vercel.app/auth/google" 
                ...
                <form onSubmit={handleSubmit} className="d-flex flex-column align-items-center w-100">
                    ...
                    <p style={{ color: `${loginMsg === "Successfully signed up, please login." ? "green" : "red"}`, margin: "4px 0", height: "10px" }}> {loginMsg} </p>
