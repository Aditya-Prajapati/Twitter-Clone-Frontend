...
export default function Signup(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios
            .post(
                "twitter-clone-backend-in-progress-91yvo9gd7-aditya-prajapati.vercel.app/auth/signup",
    ...
    return (
        <div className="card align-items-center" id="Login">
            ...
            <LoginButton link="twitter-clone-backend-in-progress-91yvo9gd7-aditya-prajapati.vercel.app/auth/google" icon={<GoogleIcon />} text={"Sign up with Google"} />
